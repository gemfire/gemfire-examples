...
public class ExampleLocationContainedInAnArea {
  public static void main(String[] args) throws InterruptedException, LuceneQueryException {
    Region<String, RegionInfo> region = ExampleCommon.createRegion("example-region-is-location-inside-shape");
  ...
  public static void verifyIfGivenLocationIsInsideShape(Region<String, RegionInfo> region, double givenLongitude, double givenLatitude) {
