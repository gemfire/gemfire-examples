...
public class Example {
    public static void main(String[] args) throws InterruptedException, LuceneQueryException {
        ...
        Region<String, RegionInfo> region =
                cache.<String, RegionInfo>createClientRegionFactory(ClientRegionShortcut.PROXY)
    ...
    public static void putEntries(LuceneService luceneService, Map<String, RegionInfo> region)
        ...
        region.put("Elmonica/SW 170th Ave",
                new RegionInfo("Elmonica/SW 170th Ave", -122.85146341202486, 45.509962691078009));
        region.put("Willow Creek/SW 185th Ave TC",
                new RegionInfo("Willow Creek/SW 185th Ave TC", -122.87021024485213, 45.517251954169652));
        region.put("Merlo Rd/SW 158th Ave",
                new RegionInfo("Merlo Rd/SW 158th Ave", -122.84216239020598, 45.505240564251949));
