...
- OpenSSL (if running with TLS enabled)
...
Exercises Put and Get operations with string, int, and bytes keys, and tests error-handling for non-existent keys and regions.
