...
gfsh -e "connect --locator=localhost[10334]" -e "create region --name=orders --type=PARTITION"
gfsh -e "connect --locator=localhost[10334]" -e 'execute function --id=InstantiateDSUser --member=server0,server1'