...
```xml
<ItemGroup>
  <PackageReference Include="GemFire.Client" Version="1.0.2" />
  <PackageReference Include="GemFire.Client.Session" Version="1.0.2" />
</ItemGroup>
```
...
```bash
dotnet add package GemFire.Client --version 1.0.2
```
...
```bash
dotnet add package GemFire.Client.Session --version 1.0.2
```
...
```powershell
Install-Package GemFire.Client -Version 1.0.2
```
...
```powershell
Install-Package GemFire.Client.Session -Version 1.0.2
```
...
│       └── GemFire.Client.Session.deps.json
│
├── GemFire.Client.1.0.2.nupkg
├── GemFire.Client.1.0.2.symbols.nupkg
├── GemFire.Client.Session.1.0.2.nupkg
└── GemFire.Client.Session.1.0.2.snupkg
```
...
**Last Updated**: This guide was last updated for VMware Tanzu GemFire .NET Client version 1.0.2.
