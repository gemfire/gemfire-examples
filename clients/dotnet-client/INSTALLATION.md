...
```xml
<ItemGroup>
  <PackageReference Include="GemFire.Client" Version="1.0.0-build.1233" />
  <PackageReference Include="GemFire.Client.Session" Version="1.0.0-build.1233" />
</ItemGroup>
```
...
```bash
dotnet add package GemFire.Client --version 1.0.0-build.1233
```
...
```bash
dotnet add package GemFire.Client.Session --version 1.0.0-build.1233
```
...
```powershell
Install-Package GemFire.Client -Version 1.0.0-build.1233
```
...
```powershell
Install-Package GemFire.Client.Session -Version 1.0.0-build.1233
```
...
│       └── GemFire.Client.Session.deps.json
│
├── GemFire.Client.1.0.0-build.1233.nupkg
├── GemFire.Client.1.0.0-build.1233.symbols.nupkg
├── GemFire.Client.Session.1.0.0-build.1233.nupkg
└── GemFire.Client.Session.1.0.0-build.1233.snupkg
```
...
**Last Updated**: This guide was last updated for VMware Tanzu GemFire .NET Client version 1.0.0-build.1233.
