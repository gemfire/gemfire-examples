...
# Example script to start a locator with custom application launcher.
#
# Usage:
# start-locator.sh [option ...]
#
...
# DO NOT export, launcher does not use this environment variable.
JAVA_OPTIONS=("-Xmx2g" "-Dgemfire.default.locators=localhost[12345]")
...
"${JAVA_HOME}"/bin/java "${JAVA_OPTIONS[@]}" \
  ...
  com.vmware.gemfire.examples.launchers.CustomLocatorApplication \
